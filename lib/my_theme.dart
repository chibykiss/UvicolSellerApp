...
class MyTheme{
  ...
  static const Color app_accent_color = const Color.fromRGBO(52, 168, 83, 1.0);
  static const Color orange = const Color(0xFFf27e15);
  static Color app_accent_color_extra_light = Color.fromRGBO(233, 233, 240, 1.0);

  static Color splash_screen_color = Color.fromRGBO(46,41,78, 1); // if not sure , use the same color as accent color
  static Color login_reg_screen_color = Color.fromRGBO(46,41,78, 1); // if not sure , use the same color as accent color
  ...
  static Color red = Color.fromRGBO(255, 115, 115, 1.0);
