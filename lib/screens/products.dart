  ...
  showDeleteWarningDialog(id) {
    showDialog(
        ...
        builder: (context) => Container(
              ...
              child: AlertDialog(
                title: Text(
                  LangText(context: context).getLocal().common_warning,
                  style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 15,
                      color: MyTheme.red),
                ...
                actions: [
                  TextButton(
                      ...
                      child: Text(
                        LangText(context: context).getLocal().common_no,
                  ...
                  TextButton(
                      ...
                      child: Text(
                          LangText(context: context).getLocal().common_yes,
                          style:
