  ...
  formValidation() {
    ...
    if (nameEditingController.text.trim().isEmpty) {
      _errors.add(LangText(context: context)
          .getLocal()
          .general_setting_screen_name_error);
    }
    if (phoneEditingController.text.trim().isEmpty) {
      _errors.add(LangText(context: context)
          .getLocal()
          .general_setting_screen_phone_error);
    }
    if (addressEditingController.text.trim().isEmpty) {
      _errors.add(LangText(context: context)
          .getLocal()
          .general_setting_screen_address_error);
    }
    if (titleEditingController.text.trim().isEmpty) {
      _errors.add(LangText(context: context)
          .getLocal()
          .general_setting_screen_title_error);
    }
    if (descriptionEditingController.text.trim().isEmpty) {
      _errors.add(LangText(context: context)
          .getLocal()
          .general_setting_screen_description_error);
    }
    if (_imageId.isEmpty) {
      _errors.add(LangText(context: context)
          .getLocal()
          .general_setting_screen_logo_error);
    }
