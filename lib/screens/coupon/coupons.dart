      ...
      child: AlertDialog(
        ...
        actions: [
          TextButton(
              ...
              }, child: Text(LangText(context: context).getLocal().common_no,style: TextStyle(color: MyTheme.black,fontSize: 12),)),
          TextButton(
              // color: MyTheme.app_accent_color,
              onPressed: (){
                Navigator.pop(context);
                deleteCoupon(id);
              }, child: Text(LangText(context: context).getLocal().common_yes,style: TextStyle(color: MyTheme.black,fontSize: 12))),
        ],
      ),
    ));
  }
