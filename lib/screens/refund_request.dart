            ...
            builder: (context,setState) {
              return AlertDialog(
                ...
                actions: [
                  ...
                  }, child: Text(LangText(context: context).getLocal().common_close,style: TextStyle(color: MyTheme.black,fontSize: 12),)),
                  Visibility(
                    ...
                    }, child: Text(LangText(context: context).getLocal().common_submit,style: TextStyle(color: MyTheme.black,fontSize: 12))),
                  ),
                ],
              );
            }
