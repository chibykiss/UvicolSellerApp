                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.w500,
                            color: MyTheme.black.withOpacity(0.8)),
                      ),
                      SizedBox(
                        height: 10,
                      ),
                      Row(
                        children: [
                          ...
                          Text(
                            "" + _rating,
                            style:
                                TextStyle(fontSize: 12, color: MyTheme.black),
                          ),
                          SizedBox(
                            width: 10,
                          ),
                              ...
                              ? Row(
                                  children: [
                                    ...
                                    Text(
                                      _package,
                                      style: TextStyle(
                                          fontSize: 12, color: MyTheme.black),
                                    ),
                                  ],
                                )
                              : Container(),
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            LangText(context: context).getLocal().drawer_logout,
                            style:
                                TextStyle(fontSize: 14, color: MyTheme.black),
                          ),
                        ],
                      ),
                      Icon(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        LangText(context: context).getLocal().drawer_profile,
                  ...
                  Row(
                    children: [
                      Image.asset('assets/icon/products.png',
                          width: 16, height: 16, color: MyTheme.black),
                      const SizedBox(
                        width: 26,
                      ),
                      Text(
                        ...
                        style:
                            const TextStyle(fontSize: 14, color: MyTheme.black),
                      ),
                    ],
                  ),
                  const Icon(
                        ...
                        child:  TextButton(
                          ...
                          child: Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  Icon(Icons.upload_file,size: 16,color: MyTheme.black,),
                                  //Image.asset('assets/icon/commission_history.png',width: 16,height: 16,color: MyTheme.black),
                                  SizedBox(width: 26,),
                                  Text(LangText(context: context).getLocal().drawer_upload_file,style: TextStyle(fontSize: 14,color: MyTheme.black),),
                                ],
                              ),
                              Icon(Icons.navigate_next_rounded,size: 20,color: MyTheme.black,)
                            ],
                          ),
                        ),
                      ),*/
