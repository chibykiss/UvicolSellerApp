        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: const EdgeInsets.only(left: 15.0),
              child: Text(
                "${LangText(context: context).getLocal().dashboard_category_wise} (${categoryWiseProducts.length})",
                style: const TextStyle(
                    fontSize: 14,
                    color: MyTheme.app_accent_color,
                    fontWeight: FontWeight.bold),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                "$_prodcutUploadLimit ${LangText(context: context).getLocal().dashboard_times}",
                                style: TextStyle(
                                    fontSize: 10,
                                    color: MyTheme.grey_153,
                                    fontWeight: FontWeight.w400),
