  ...
  Visibility buildAppBar(BuildContext context) {
    return Visibility(
        ...
        child: SizedBox(
          ...
          child: MyAppBar(
                  context: context,
                  title: LangText(context: context).getLocal().drawer_orders)
              .show(),
        ));
  }
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                          "${LangText(context: context).getLocal().order_list_screen_payment_status} - ",
                          style: TextStyle(
                              color: MyTheme.font_grey,
                              fontSize: 12,
                              fontWeight: FontWeight.w400)),
                ...
                Row(
                  children: [
                    ...
                    Text(
                        "${LangText(context: context).getLocal().order_list_screen_delivery_status} -",
                        style: TextStyle(
                            color: MyTheme.font_grey,
                            fontSize: 12,
                            fontWeight: FontWeight.w400)),
            ...
            children: [
              MyWidget.customCardView(
                ...
                child: new DropdownButton<PaymentStatus>(
                  ...
                  hint: Text(
                    LangText(context: context).getLocal().order_list_screen_all,
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 13,
                    ),
